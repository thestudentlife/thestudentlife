...
selenium.get("http://localhost:8000/workflow/articles/issue/2/1/")
...
section_caret = selenium.find_element_by_xpath('/html/body/div/div[1]/form/div[2]/div/span')
section_caret.click()
section_caret.click()
section = selenium.find_element_by_xpath('/html/body/div/div[1]/form/div[2]/div/ul/li[3]')
section.click()
